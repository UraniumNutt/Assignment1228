...
module EightBitFullAdder(
    ...
    OneBitFullAdder onebitfulladder0(S[0], C0,   A[0], B[0], Cin); // the first bit takes the Cin for the whole adder
    ...
    OneBitFullAdder onebitfulladder7(S[7], Cout, A[7], B[7], C6); // the last bit provides the Cout for the whole adder
