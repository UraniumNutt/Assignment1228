...
module Multiplexer( // implementing multiplexer for Structural version
    output [7:0] O,
    input [7:0] A,
    input [7:0] B,
    input S
    ...
    OneBitMultiplexer Bit0(O[0], A[0], B[0], S); // creates an instance of the one bit multiplexer for each bit of the bus inputs
